...
const day_result = document.querySelector('.day-selector');
...
btn.addEventListener('click', (e)=>{
    ...
    if(day.value =='' || month.value == '' || year.value == ''){
        ...
        day_err.textContent = 'Must be in the day';
    }else if(month.value >12){
        month_err.textContent ='Must be in the month';
